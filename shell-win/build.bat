...
"%CSC%" /nologo /langversion:latest /unsafe /target:winexe /platform:x64 /optimize+ /out:"%HERE%PetCat.exe" "%HERE%PetCat.cs" "%HERE%Shell.cs" "%HERE%DockRing.cs" /r:System.dll /r:System.Drawing.dll /r:System.Windows.Forms.dll /r:System.Web.Extensions.dll /r:System.Net.Http.dll /r:"%HERE%wv2\lib\net462\Microsoft.Web.WebView2.Core.dll" /r:"%HERE%wv2\lib\net462\Microsoft.Web.WebView2.WinForms.dll"
